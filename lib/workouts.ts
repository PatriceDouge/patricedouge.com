...
const data: [string, WorkoutCategory, string, string, string][] = [
  // W1 (Mar 9–15)
  ["2026-03-09", "run", "Run Q1", "7mi total · 5×4:00 @ T", "2 mi WU + drills/strides, 5×4:00 @ T (7:20–7:35/mi) w/90s jog, 2 mi CD."],
  ["2026-03-10", "run", "Easy + Lift A", "6mi easy + Lift A", "6 mi easy (8:55–9:45/mi). PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-03-11", "run", "Run Q2", "7mi total · 3×1mi @ T", "2 mi WU, 3×1 mi @ T (7:20–7:35/mi) w/75s jog, 2 mi CD."],
  ...
  ["2026-03-16", "run", "Run Q1", "6.5mi total · 3×5:00 @ T", "2 mi WU + drills, 3×5:00 @ T (7:20–7:35/mi) w/90s jog, 2 mi CD, 0.5 mi easy."],
  ["2026-03-17", "run", "Easy + Lift A", "5mi easy + Lift A", "5 mi easy (8:55–9:45/mi). PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-03-18", "run", "Run Q2", "6.5mi total · 3mi @ HM", "2 mi WU, 3 mi continuous @ HM effort (7:15–7:25/mi), 1.5 mi CD."],
  ...
  // W3 (Mar 23–29)
  ["2026-03-23", "run", "Run Q1", "8mi total · 4×5:00 @ T", "2 mi WU + drills, 4×5:00 @ T (7:20–7:35/mi) w/90s jog, 2 mi CD, 1 mi easy."],
  ["2026-03-24", "run", "Easy + Lift A", "6mi easy + Lift A", "6 mi easy. PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-03-25", "run", "Run Q2", "8mi total · 4×1mi @ T", "2 mi WU, 4×1 mi @ T (7:20–7:35/mi) w/75s jog, 2 mi CD."],
  ...
  // W4 (Mar 30–Apr 5)
  ["2026-03-30", "run", "Run Q1", "8.5mi total · 4×1mi @ T", "2 mi WU + drills, 4×1 mi @ T (7:20–7:35/mi) w/75s jog, 2 mi CD, 0.5 mi easy."],
  ["2026-03-31", "run", "Easy + Lift A", "6.5mi easy + Lift A", "6.5 mi easy. PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-04-01", "run", "Run Q2", "9mi total · 2×2mi @ HM/T", "2 mi WU, 2×2 mi @ HM/T (7:15–7:30/mi) w/2:30 jog, 2 mi CD, 1 mi easy."],
  ...
  ["2026-04-06", "run", "Run Q1", "9mi total · 6×1km @ 10M", "2 mi WU + drills, 6×1 km @ 10M effort (7:05–7:15/mi) w/75s jog, 2 mi CD, 1 mi easy."],
  ["2026-04-07", "run", "Easy + Lift A", "6.5mi easy + Lift A", "6.5 mi easy. PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-04-08", "run", "Run Q2", "9.5mi total · 2×3mi @ HM", "2 mi WU, 2×3 mi @ HM effort (7:15–7:25/mi) w/3:00 jog, 2 mi CD, 0.5 mi easy."],
  ...
  ["2026-04-13", "run", "Run Q1", "8mi total · 3×1mi @ 10M", "2 mi WU + drills, 3×1 mi @ 10M effort (7:05–7:15/mi) w/2:00 jog, 2 mi CD, 1 mi easy."],
  ["2026-04-14", "run", "Easy + Lift A", "5.5mi easy + Lift A", "5.5 mi easy. PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-04-15", "run", "Run Q2", "7.5mi total · 4×4:00 @ T", "2 mi WU, 4×4:00 @ T (7:20–7:35/mi) w/90s jog, 2 mi CD, 0.5 mi easy."],
  ...
  ["2026-04-20", "run", "Run Q1", "7mi total · 3×1mi @ T", "2 mi WU, 3×1 mi @ T (7:20–7:35/mi) w/75s jog, 1.5–2 mi CD."],
  ["2026-04-21", "run", "Easy + Lift A", "5.5mi easy + Lift A", "5.5 mi easy. PM Lift A: Squat · Bench · Pull-Ups + shoulder superset."],
  ["2026-04-22", "run", "Run Q2", "8mi total · 2×2mi @ HM", "2 mi WU, 2×2 mi @ HM effort (7:15–7:25/mi) w/3:00 jog, 2 mi CD."],
