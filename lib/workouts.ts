...
export const trainingWeeks: TrainingWeek[] = [
  ...
  { label: "W6", start: "2026-07-06", end: "2026-07-12", miles: "49", note: "Strength · LT tempo + sub-T long" },
  { label: "W7", start: "2026-07-13", end: "2026-07-19", miles: "52", note: "Strength · MP long-run finish" },
  ...
  { label: "W11", start: "2026-08-10", end: "2026-08-16", miles: "51", note: "Specific · LT tempo + progressive long" },
...
const data: [string, WorkoutCategory, string, string, string, string?][] = [
  ...
  ["2026-06-04", "run", "Threshold", "6mi · 4×1mi @ T", "1 mi WU, 4×1 mi @ T (7:20–7:35/mi) w/75s jog, 1 mi CD."],
  ...
  ["2026-06-11", "run", "Threshold", "8mi · 4×1mi @ T", "1 mi WU, 4×1 mi @ T (7:20–7:35/mi) w/75s jog, 1 mi CD, easy to 8 total."],
  ...
  ["2026-06-14", "run", "Long Run", "10mi · easy long", "10 mi long run, easy (8:55–9:45/mi)."],
  // W3 (Jun 15–21) — 47
  ...
  ["2026-06-18", "run", "Threshold", "8.5mi · 5×1mi @ T", "1 mi WU, 5×1 mi @ T (7:20–7:35/mi) w/75s jog, 1 mi CD, easy to 8.5 total."],
  ...
  ["2026-06-21", "run", "Long Run", "11mi · last 2 steady", "11 mi long run: easy, last 2 mi steady (8:05–8:40/mi)."],
  // W4 (Jun 22–28) — 50
  ...
  ["2026-06-25", "run", "Threshold", "9mi · 3×2mi @ T", "1 mi WU, 3×2 mi @ T (7:20–7:35/mi) w/2:30 jog, 1 mi CD, easy to 9 total."],
  ...
  ["2026-07-02", "run", "Threshold", "7mi · 3×1mi @ T", "1 mi WU, 3×1 mi @ T (7:20–7:35/mi) w/75s jog, 1 mi CD, easy to 7 total."],
  ...
  ["2026-07-09", "run", "Threshold", "8.5mi · 3mi LT tempo", "1.5 mi WU, 3 mi continuous @ LT (7:25–7:35/mi), 1.5 mi CD, easy to 8.5 total."],
  ...
  ["2026-07-12", "run", "Long Run", "12mi · 3×15:00 sub-T", "12 mi long run with 3×15:00 @ sub-T (7:45–8:05/mi) w/3:00 float (8:00–8:20/mi); easy the rest."],
  ...
  ["2026-07-16", "run", "Threshold", "9mi · 4mi LT tempo", "1.5 mi WU, 4 mi continuous @ LT (7:25–7:35/mi), 1.5 mi CD, easy to 9 total."],
  ...
  ["2026-07-19", "run", "Long Run", "13mi · last 4 @ MP", "13 mi long run, last 4 mi at MP effort (7:45–8:00/mi)."],
  ...
  ["2026-07-23", "run", "Threshold", "8.5mi · 2×2mi @ HMP", "1 mi WU, 2×2 mi @ HM pace (7:25/mi) w/3:00 jog, 1 mi CD, easy to 8.5 total."],
  ...
  ["2026-07-30", "run", "Threshold", "7mi · 3×1mi @ T", "1 mi WU, 3×1 mi @ T (7:20–7:35/mi) w/75s jog, 1 mi CD, easy to 7 total."],
  ...
  ["2026-08-02", "run", "Long Run", "12mi · easy long", "12 mi long run, easy (8:55–9:45/mi)."],
  ...
  ["2026-08-16", "run", "Long Run", "12mi · prog → HMP", "12 mi long run: 7 mi easy, last 5 mi progressive to HM pace (finish ~7:25/mi)."],
  ...
  ["2026-08-20", "run", "Threshold", "9.5mi · 3×2mi @ HMP", "1 mi WU, 3×2 mi @ HM pace (7:25/mi) w/2:30 jog, 1 mi CD, easy to 9.5 total."],
  ...
  ["2026-08-23", "run", "Long Run", "12mi · 2×3mi @ HMP", "12 mi long run with 2×3 mi @ HM pace (7:25/mi) w/0.5 mi float; easy the rest."],
  ...
  ["2026-08-27", "run", "Threshold", "7mi · 2×1mi HMP + 2×3:00 T", "1 mi WU, 2×1 mi @ HM pace (7:25/mi) w/2:30 jog, 2×3:00 @ T (7:20–7:35/mi) w/90s jog, 1 mi CD."],
