...
export const trainingWeeks: TrainingWeek[] = [
  ...
  { label: "W11", start: "2026-08-10", end: "2026-08-16", miles: "49", note: "Specific · LT tempo + HMP long-run reps" },
...
const data: [string, WorkoutCategory, string, string, string, string?][] = [
  ...
  ["2026-08-03", "run", "Easy + Upper A", "4mi · easy", "4 mi easy (8:55–9:45/mi). Upper A light — race week.", "upperA"],
  ["2026-08-04", "run", "Sub-T", "7mi · 3×6:00 @ LT1", "1 mi WU, 3×6:00 @ LT1 (7:45–8:05/mi) w/90s jog, 1 mi CD, easy to 7 total. Sharpen for the 10K."],
  ["2026-08-05", "run", "MLR", "8mi · MLR easy", "8 mi medium-long run, easy (8:55–9:45/mi). No Lower lift — race week."],
  ...
  ["2026-08-09", "run", "Recovery", "6mi · recovery", "6 mi very easy recovery (9:30–10:30+/mi)."],
  // W11 (Aug 10–16) — 49 · specific
  ["2026-08-10", "run", "Recovery + Upper A", "5mi · recovery", "5 mi recovery (9:30–10:30+/mi). Easy day after the 10K weekend.", "upperA"],
  ["2026-08-11", "run", "Sub-T", "8mi · 4×8:00 @ LT1", "1 mi WU, 4×8:00 @ LT1 (7:45–8:05/mi) w/90s jog, 1 mi CD, easy to 8 total."],
  ["2026-08-12", "run", "MLR + Lower", "9mi · MLR easy", "9 mi medium-long run, easy (8:55–9:45/mi).", "lower"],
  ["2026-08-13", "run", "Threshold", "6mi · 4mi LT tempo", "1 mi WU, 4 mi continuous @ LT (7:25–7:35/mi), 1 mi CD, easy to 6 total."],
  ["2026-08-14", "run", "Recovery + Upper B", "5mi · recovery", "5 mi recovery (9:30–10:30+/mi).", "upperB"],
  ["2026-08-15", "run", "Easy + Strides", "4mi · easy + strides", "4 mi easy (8:55–9:45/mi) + 4×20s strides."],
  ...
  ["2026-08-17", "run", "Recovery + Upper A", "5mi · recovery", "5 mi recovery (9:30–10:30+/mi). Easy day after Sunday long run.", "upperA"],
  ["2026-08-18", "run", "Sub-T", "9mi · 3×10:00 @ LT1", "1 mi WU, 3×10:00 @ LT1 (7:45–8:05/mi) w/2:00 jog, 1 mi CD, easy to 9 total."],
  ["2026-08-19", "run", "MLR + Lower", "10mi · MLR easy", "10 mi medium-long run, easy (8:55–9:45/mi).", "lower"],
  ["2026-08-20", "run", "Threshold", "6mi · 2×2mi @ HMP", "1 mi WU, 2×2 mi @ HM pace (7:25/mi) w/3:00 jog, 1 mi CD, easy to 6 total."],
  ["2026-08-21", "run", "Recovery + Upper B", "5mi · recovery", "5 mi recovery (9:30–10:30+/mi).", "upperB"],
  ["2026-08-22", "run", "Easy + Strides", "4mi · easy + strides", "4 mi easy (8:55–9:45/mi) + 4×20s strides."],
  ["2026-08-23", "run", "Long Run", "13mi · last 4 @ HMP", "13 mi long run, last 4 mi at HM pace (7:25/mi)."],
  // W13 (Aug 24–30) — 43 · taper begins (last full Lower Wed)
  ["2026-08-24", "run", "Recovery + Upper A", "4mi · recovery", "4 mi recovery (9:30–10:30+/mi). Taper — drop 1 set per lift.", "upperA"],
  ["2026-08-25", "run", "Sub-T", "7mi · 3×6:00 @ LT1", "1 mi WU, 3×6:00 @ LT1 (7:45–8:05/mi) w/90s jog, 1 mi CD, easy to 7 total."],
  ["2026-08-26", "run", "MLR + Lower", "8mi · MLR easy", "8 mi medium-long run, easy (8:55–9:45/mi). Last full Lower of the block.", "lower"],
  ["2026-08-27", "run", "Threshold", "6mi · 2×10:00 @ T", "1 mi WU, 2×10:00 @ T (7:20–7:35/mi) w/2:30 jog, 1 mi CD, easy to 6 total. Taper — controlled, sharp."],
  ["2026-08-28", "run", "Recovery + Upper B", "4mi · recovery", "4 mi recovery (9:30–10:30+/mi). Taper — drop 1 set per lift.", "upperB"],
  ["2026-08-29", "run", "Easy + Strides", "3mi · easy + strides", "3 mi easy (8:55–9:45/mi) + 4×20s strides."],
  ...
  ["2026-08-31", "run", "Easy + Upper A", "3mi · easy", "3 mi easy (8:55–9:45/mi). Upper A optional/light — race week.", "upperA"],
  ...
  ["2026-09-02", "run", "Easy + Strides", "4mi · easy + strides", "4 mi easy (8:55–9:45/mi) + 4×20s strides. No Lower lift — race week."],
  ["2026-09-03", "run", "Easy", "4mi · easy", "4 mi easy (8:55–9:45/mi)."],
